...
function getNavItems(role: string) {
  ...
  const roleSpecificItems: Record<string, Array<{ href: string; label: string; icon: typeof Home }>> = {
    farmer: [
      ...
      { href: `/dashboard/farmer/requests`, label: "Purchase Requests", icon: FileText },
      { href: `/dashboard/farmer/orders`, label: "Order Status", icon: Truck },
      { href: `/dashboard/farmer/payments`, label: "Payments", icon: CreditCard },
    ],
    shg: [
      { href: `/dashboard/shg`, label: "Overview", icon: Home },
      { href: `/dashboard/shg/farmers`, label: "Farmer Listings", icon: Users },
      { href: `/dashboard/shg/orders`, label: "Purchase Orders", icon: ShoppingCart },
      { href: `/dashboard/shg/batches`, label: "Processing Batches", icon: Package },
      { href: `/dashboard/shg/products`, label: "My Products", icon: Store },
    ],
    consumer: [
      { href: `/dashboard/consumer`, label: "Overview", icon: Home },
      { href: `/dashboard/consumer/products`, label: "Browse Products", icon: Store },
    ...
    admin: [
      ...
      { href: `/dashboard/admin/quality`, label: "Quality Review", icon: ClipboardCheck },
      { href: `/dashboard/admin/batches`, label: "Batch Approval", icon: CheckSquare },
